...
public class motorPIDSource implements PIDSource {
  ...
  private double m_maxRate; // Maximum Rate for motoros
   ...
   *        positive values.
   */
  public motorPIDSource(final int aChannel, final int bChannel, boolean reverseDirection) {
    m_allocatedA = true;
    m_allocatedB = true;
    m_allocatedI = false;
   ...
   */
  public CustomEncoder(final int aChannel, final int bChannel) {
   ...
   */
  public CustomEncoder(final int aChannel, final int bChannel, boolean reverseDirection,
   ...
   *        positive values.
   */
  public CustomEncoder(final int aChannel, final int bChannel, final int indexChannel,
   ...
   *        positive values.
   */
  public CustomEncoder(DigitalSource aSource, DigitalSource bSource, boolean reverseDirection) {
    m_allocatedA = false;
    m_allocatedB = false;
    m_allocatedI = false;
    if (aSource == null)
   ...
   * @param bSource the source that should be used for the b channel.
   */
  public CustomEncoder(DigitalSource aSource, DigitalSource bSource) {
   ...
   *        positive values.
   */
  public CustomEncoder(DigitalSource aSource, DigitalSource bSource, DigitalSource indexSource,
      boolean reverseDirection) {
    m_allocatedA = false;
    m_allocatedB = false;
    m_allocatedI = false;
